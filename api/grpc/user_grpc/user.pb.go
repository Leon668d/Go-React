...
var file_user_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x47, 0x0a, 0x0d, 0x4c, 0x6f,
	0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x55,
	...
	0x6f, 0x72, 0x64, 0x32, 0x72, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x32, 0x0a, 0x05,
	...
	0x12, 0x35, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x12, 0x2e, 0x75,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0c, 0x5a, 0x0a, 0x2f, 0x75, 0x73, 0x65, 0x72,
...
var file_user_proto_depIdxs = []int32{
	0, // 0: user.Login.Login:input_type -> user.LoginRequest
	0, // 1: user.Login.Register:input_type -> user.LoginRequest
	1, // 2: user.Login.Login:output_type -> user.LoginResponse
	1, // 3: user.Login.Register:output_type -> user.LoginResponse
...
func (c *loginClient) Register(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, "/user.Login/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Login_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.Login/Register",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
